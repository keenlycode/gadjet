...
})({"3KaRR":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "cb604c88e4e6159b";
...
},{}],"1kdVp":[function(require,module,exports) {
...
.bg-theme-frost {
    ${(0, _style.bgColor)((0, _color.theme).frost)}
}
.bg-theme-blueGreen {
    ${(0, _style.bgColor)((0, _color.theme).blueGreen)}
}
.bg-theme-yellow {
    ${(0, _style.bgColor)((0, _color.theme).yellow)}
}
.bg-theme-light {
    ${(0, _style.bgColor)((0, _color.theme).light)}
}
.bg-theme-dark {
    ${(0, _style.bgColor)((0, _color.theme).dark)}
}
...
.bg-red {
    ${(0, _style.bgColor)((0, _color.color).red)}
}
.bg-green {
    ${(0, _style.bgColor)((0, _color.color).green)}
}
.bg-yellow {
    ${(0, _style.bgColor)((0, _color.color).yellow)}
}
.bg-orange {
    ${(0, _style.bgColor)((0, _color.color).orange)}
}
.bg-purple {
    ${(0, _style.bgColor)((0, _color.color).purple)}
}
.bg-brown {
    ${(0, _style.bgColor)((0, _color.color).brown)}
}

.bg-red-int {
    ${(0, _style.bgColorInt)({
    color: (0, _color.color).red
})}
}
.bg-green-int {
    ${(0, _style.bgColorInt)({
    color: (0, _color.color).green
})}
}
.bg-yellow-int {
    ${(0, _style.bgColorInt)({
    color: (0, _color.color).yellow
})}
}
.bg-orange-int {
    ${(0, _style.bgColorInt)({
    color: (0, _color.color).orange
})}
}
.bg-purple-int {
    ${(0, _style.bgColorInt)({
    color: (0, _color.color).purple
})}
}
.bg-brown-int {
    ${(0, _style.bgColorInt)({
    color: (0, _color.color).brown
})}
}
`;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3KaRR","1kdVp"], "1kdVp", "parcelRequirefd77")

//# sourceMappingURL=color.style.js.map
