...
})({"jPPfR":[function(require,module,exports) {
"use strict";
...
(0, _ui.define)("el-tab", (0, _tab.Tab));
...
class Tab extends (0, _ui.StyledElement) {
...
class TabStyle extends (0, _ui.StyleClass) {
    static default = {
        tabColor: "#ccc",
        hoverColor: "#ddd",
        activeColor: "blue",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jPPfR","380x2"], "380x2", "parcelRequirefd77")
