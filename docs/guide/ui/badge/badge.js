...
})({"0k6hs":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "1d13fb78a22fcaec";
"use strict";
...
},{}],"4BnUq":[function(require,module,exports) {
var _addStyle = require("gadjet/src/style/add-style");
var _badge = require("gadjet/src/ui/badge/badge");
var _color = require("../../../color");
(0, _badge.Badge).define("el-badge");
(0, _badge.Badge).classStyle("blue", {
    color: (0, _color.color).blue
});
(0, _badge.Badge).classStyle("green", {
    color: (0, _color.color).green
});
(0, _badge.Badge).classStyle("yellow", {
    color: (0, _color.color).yellow
});
(0, _badge.Badge).classStyle("red", {
    color: (0, _color.color).red
});
(0, _badge.Badge).classStyle("purple", {
    color: (0, _color.color).purple
});
(0, _addStyle.addStyle)`
.preview {
    ${(0, _badge.Badge).tagName} {
        margin: 0.5rem;
    }
}
`;

},{"gadjet/src/style/add-style":"jkvY3","gadjet/src/ui/badge/badge":"hRUly","../../../color":"9for5"}],"jkvY3":[function(require,module,exports) {
...
},{"@emotion/cache":"3Umtj","@emotion/serialize":"kS2E2","@emotion/utils":"6UI8e","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hRUly":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"gadjet/src/style/add-style":"jkvY3","gadjet/src/style/bg-color":"celAt","gadjet/src/style/bg-color-int":"ckzzz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["0k6hs","4BnUq"], "4BnUq", "parcelRequirefd77")
