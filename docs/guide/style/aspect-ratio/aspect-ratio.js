...
})({"9ZBTV":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = 1234;
...
_style.addStyle`
.aspectRatio-4-3 {
    ${_style.aspectRatio('4/3')}
}
.aspectRatio-16-9 {
    ${_style.aspectRatio('16/9')}
}
.aspectRatio-1-1 {
    ${_style.aspectRatio('1')}
}
.aspectRatio-21-9 {
    ${_style.aspectRatio('21/9')}
}
`;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9ZBTV","aBz8x"], "aBz8x", "parcelRequirefd77")
