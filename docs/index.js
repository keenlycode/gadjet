...
})({"cMqRF":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = 1234;
...
_ui.define('el-styled', _ui.StyledElement);
_ui.define('el-badge', _badge.Badge);
_ui.define('el-card', _card.Card);
_button.Button.tagStyle({
    color: _color.theme.yellow
});
_button.Button.classStyle('violet', {
    color: _color.theme.violet
});
_button.Button.classStyle('big', `font-size: 2em;`);
_button.Button.classStyle('dark', {
    color: _color.theme.dark
});
_button.Button.classStyle('light', {
...
class Button extends _ui.StyledElement {
    static Style = _buttonStyle.ButtonStyle;
...
class Card extends _ui.StyledElement {
    static Style = _cardStyle.CardStyle;
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
var _style = require("../../style");
var _ui = require("../ui");
class CardStyle extends _ui.StyleClass {
    static default = {
        color: '#eee',
        borderRadius: '4px'
    };
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cMqRF","7S22T"], "7S22T", "parcelRequirefd77")
